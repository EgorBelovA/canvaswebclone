...
class CustomUserCreationForm(UserCreationForm):
    first_name = forms.CharField(label='Username', max_length=100, required=True, widget=forms.TextInput(attrs={'autofocus': 'on', 'autocomplete': 'new-password', 'class': 'form-input', 'placeholder': 'Enter username'}), error_messages={'invalid': 'INVALID!!11', 'null': 'NULL11!'})
